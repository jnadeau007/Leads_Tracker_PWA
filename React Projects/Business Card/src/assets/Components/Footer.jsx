    ...
    return (
        <footer className="footer-container">
            <div className="footer-links">
                <a href="https://github.com/jamNad007" target="_blank" rel="noreferrer" aria-label="GitHub">
                ...
                <a href="/Developer James Nadeau Resume.docx" className="footer-text-link" download>Resume</a>
            </div>
